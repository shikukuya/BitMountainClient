...
class LoginPanel extends Component {
   ...
   */
  getDivByMood = () => {
    const {isLoginWaiting, passwordHintText} = this.state;
    if (this.state.isPasswordMood) {
      return (
          <div className="passwordMood">
            ...
            <div className="passwordMoodHint">{passwordHintText}</div>
          </div>
      );
    } else {
      const {emailMoodHintText} = this.state;
      return (
          <div className="emailMood">
            ...
            <div className="emailMoodHint">{emailMoodHintText}</div>
          </div>
      );
    }
  };
