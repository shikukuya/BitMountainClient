  ...
  render() {
    ...
    return (
        <div className="loginPanel" style={curStyle}>
          ...
          <div className="panel">
            <div className="close" onClick={this.closeHandle}>X</div>
            <div className="topLine">
              <img src={require("../../utils/img/bitMountainLogo.png")} alt="" className="logoImg"/>
              <span>比特山</span>
            </div>
            {this.getDivByMood()}
            ...
            <div className="bottomLine" ref={this.bottomLine}>
              ...
              <span>我同意</span>
              <NavLink className="" to="/termsAndConditions" onClick={this.closeHandle}>《用户协议》</NavLink>
            </div>
          </div>
        </div>
    );
    ...
    if (this.state.isPasswordMood) {
      return (
          <div className="passwordMood">
            ...
            <input ref={this.inputUserNameEle} className="inputLine" type="text" placeholder="用户名"/>
            <input ref={this.inputPasswordEle} className="inputLine" type="password" placeholder="密码"/>
            <button className={isLoginWaiting ? "loginButton loginWait" : "loginButton"}
            ...
            <div className="subLine">
              ...
              <div className="right">
                <NavLink to="/reset" onClick={this.handleForgetPassword}>忘记密码</NavLink>
              </div>
            </div>
      ...
      return (
          <div className="emailMood">
            ...
            <input ref={this.inputEmailEle} className="inputLine" type="text" placeholder="输入邮箱"/>
            <div className="inputLine">
              <input ref={this.inputCodeEle} className="inputCode" type="text" placeholder="验证码"/>
              <button className="getCodeBtn" onClick={this.handleGetCode}>获取验证码</button>
            </div>
