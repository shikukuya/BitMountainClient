    ...
    if (USER_DATA.isLogin) {
      return (
        <div className="line">
          ...
          <p>
            当前分数：<span>{USER_DATA.score}</span>
          </p>
          <p>
            最高分数：<span>{USER_DATA.maxScore}</span>
          </p>
          <p>
            胜利场数：<span>{USER_DATA.winCount}</span>
          </p>
          <p>
            失败场数：<span>{USER_DATA.loseCount}</span>
          </p>
          <p>
            对局总数：<span>{USER_DATA.matchCount}</span>
          </p>
          <p>
