 ...
 * @param isDash
 */
export function drawLine(ctx, x1, y1, x2, y2, lineWidth = 1, color = "black", isDash = false) {
 ...
 * @param color
 */
export function drawRectFill(ctx, x, y, width, height, color) {
    ctx.fillStyle = color;
 ...
 */
export function writeFont(ctx, content, x, y, color = "black", fontSize = 20) {
    ctx.fillStyle = color;
